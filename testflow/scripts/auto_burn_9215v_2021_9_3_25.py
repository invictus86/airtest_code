...
os.system(
    r'explorer.exe /n, D:\9215v\SSI.dsd9215v_master.2021.09.03.25\SSI.dsd9215v_master.2021.09.03.25')
time.sleep(1)
...
file_operate.cope_file_src_dst(r"D:\9215v\dsd9215_fuse\fastboot.bin",
                               r"F:fastboot.bin")
file_operate.cope_file_src_dst(r"D:\9215v\dsd9215_fuse\pv_cfg_dbg_vmx_production.txt",
...
file_operate.cope_floder_src_dst(r"D:\9215v\dsd9215_fuse\lib", r"F:lib")
...
def auto_xshell_input():
    ...
    cmd41_5 = "export LD_LIBRARY_PATH=/mnt/hdd_1/lib/:$LD_LIBRARY_PATH"
