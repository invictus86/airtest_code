...
os.system(r'explorer.exe /n, D:\DCD7015vALK\din7005')
time.sleep(1)
...
file_operate.cope_file_src_dst(r"D:\DCD7015vALK\din7005\all_fuse_tool\fuse_tool_vmx_v1.3",
                               r"F:fuse_tool_vmx_v1.3")
file_operate.cope_file_src_dst(r"D:\DCD7015vALK\din7005\images", r"F:images")

file_operate.cope_file_src_dst(r"D:\DCD7015vALK\din7005\loader\bootenv.ubo", r"F:bootenv.ubo")
file_operate.cope_file_src_dst(r"D:\DCD7015vALK\din7005\loader\deviceinfo.abs", r"F:deviceinfo.abs")
file_operate.cope_file_src_dst(r"D:\DCD7015vALK\din7005\loader\erase_loader_data.bin", r"F:erase_loader_data.bin")
file_operate.cope_file_src_dst(r"D:\DCD7015vALK\din7005\loader\fsi.bin", r"F:fsi.bin")
file_operate.cope_file_src_dst(r"D:\DCD7015vALK\din7005\loader\product_sabbat_dual.abs", r"F:product_sabbat_dual.abs")
file_operate.cope_file_src_dst(r"D:\DCD7015vALK\din7005\loader\see_bin.ubo", r"F:see_bin.ubo")
file_operate.cope_file_src_dst(r"D:\DCD7015vALK\din7005\loader\vmlinux_signed_loader.bin",
...
def auto_xshell_input():
    ...
    cmd2 = ("tftp %s:product_sabbat_dual.abs;nor write 0x80007fc0 0 ${filesize};" % (current_ip))
    cmd3 = "tftp {}:bootenv.ubo;nor write 0x80007fc0 0x00260000 0x20000;".format(current_ip)
    cmd4 = "tftp {}:boot_logo.bin;nor write 0x80007fc0 0x00240000 0x20000;".format(current_ip)
    cmd5 = "reset"
