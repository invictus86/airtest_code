...
with open(r"C:\Users\ivan.zhao\PycharmProjects\airtest_code\testflow\scripts\config.json", 'r') as load_f:
    ...
    # print(load_dict)
    dtn7414g_stream_file = load_dict.get("dtn7414g_stream_file")
    dtn7414g_download_file = load_dict.get("dtn7414g_download_file")
    print(dtn7414g_stream_file)
...
time.sleep(0.5)
xshell_import_cmd(dtn7414g_stream_file)
...
time.sleep(0.5)
xshell_import_cmd(dtn7414g_download_file)
...
os.system("taskkill /F /IM WinGDB_v1.3.0.exe")
