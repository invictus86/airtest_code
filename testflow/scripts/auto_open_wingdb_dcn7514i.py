...
with open(r"C:\Users\ivan.zhao\PycharmProjects\airtest_code\testflow\scripts\config.json", 'r') as load_f:
    ...
    # print(load_dict)
    dcn7514i_stream_file = load_dict.get("dcn7514i_stream_file")
    dcn7514i_download_file = load_dict.get("dcn7514i_download_file")
    print(dcn7514i_stream_file)
    print(dcn7514i_download_file)
...
time.sleep(0.5)
xshell_import_cmd(dcn7514i_stream_file)
...
time.sleep(0.5)
xshell_import_cmd(dcn7514i_download_file)
